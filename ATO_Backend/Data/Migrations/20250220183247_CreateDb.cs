        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UnitProduct = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("053d18ef-ba0e-4141-b142-898d28fa9b5d"), 0, null, "ec2f0336-fe45-4b34-a890-0b0569155edb", null, "truongthu112201@gmail.com", true, "Tourism Companies", null, false, null, "TRUONGTHU112201@GMAIL.COM", "TOURISMCOMPANIES", "AQAAAAIAAYagAAAAEPs72vFml58JpSg7vWiO954iakEvWqwoqBCBRzqNZZ8sHCHWyQ+pB65kUdVT3gToXA==", null, false, "ca5f399a-479f-4cea-87e1-5b8e227ff459", false, "TourismCompanies", true },
                    { new Guid("11a068d3-9af4-484c-82a2-e2b5c9d8b5ab"), 0, null, "e8042697-2605-4465-b90c-ae531fa8986a", null, "lucianafuste0717@gmail.com", true, "Content Moderators", null, false, null, "LUCIANAFUSTE0717@GMAIL.COM", "CONTENTMODERATORS", "AQAAAAIAAYagAAAAEONkqx48CJQ0gAxt4o5EWxELD26rN5QLqzPO5ngo0DdUYkDWioSjA3un1DLht60nHA==", null, false, "f697f610-554f-465b-9c88-9f980ddd1fd3", false, "ContentModerators", true },
                    { new Guid("64454a5e-9883-4548-9a9d-d7986bf6b3ad"), 0, null, "6407179c-a392-4738-8d61-94a05c1f1a1b", null, "thuthuhe2501@gmail.com", true, "TourGuides", null, false, null, "THUTHUHE2501@GMAIL.COM", "TOURGUIDES", "AQAAAAIAAYagAAAAELd/Q7H/2ajZoYkyHQ2LcBFBBU+D8qzYP/HK0H0F3Uv2IzWNngNjmAt49nsvmrH5hg==", null, false, "cefff77a-9b6b-4f0c-bb54-c4b82738e9dc", false, "TourGuides", true },
                    { new Guid("a631bb94-66d8-44db-932b-532892d87754"), 0, null, "0fe6a537-0154-4c2c-9188-b296e9464fcd", null, "thutt170727@gmail.com", true, "Agricultural Tourism Facility Owners", null, false, null, "THUTT170727@GMAIL.COM", "ATFO", "AQAAAAIAAYagAAAAEHdFcPMdCMcN6noXGa/FROHRYgNeYGSTY+dbAR8lOj6XsJQYUsE2zdhSxyxun2iK4w==", null, false, "402603ec-ecbc-4d2d-8377-dda9561bb6f0", false, "ATFO", true },
                    { new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), 0, null, "035008b9-3413-4bf0-8408-0e4c201c06b6", null, "thutt170727@gmail.com", true, "Administrator", null, false, null, "THUTT170727@GMAIL.COM", "ADMINISTRATOR", "AQAAAAIAAYagAAAAEAX28IfkJNoDAguVPuAobnbCoGmL+9baGjX+s68wR8oI8fhjYHK6O9ZL7hU8J+LpdA==", null, false, "3d856e29-b587-4482-96dd-0da400512ba1", false, "Administrator", true },
                    { new Guid("e025738e-4686-4282-abc3-dae9c65907f0"), 0, null, "4fc8089a-a27e-4143-9192-34b515977ce8", null, "ThangNVSE151059@fpt.edu.vn", true, "Tourists", null, false, null, "THANGNVSE151059@FPT.EDU.VN", "TOURIST", "AQAAAAIAAYagAAAAEMo2zlxYswNHxVatrYLu/SssdET6vDyFxljmmqrvwg3dB/x+SEsr44EuV3AvtuHETg==", null, false, "2c1bc031-ec6f-42b9-96f4-e0d6b053dbef", false, "Tourists", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("08ccb883-2bc5-4ccb-8ebe-60bfd9ebd4cd"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6458), "Người dùng không thể đăng nhập dù đã nhập đúng tài khoản và mật khẩu.", 3, "1. Kiểm tra xem tài khoản có bị khóa hay không. \n2. Hướng dẫn người dùng đặt lại mật khẩu. \n3. Kiểm tra lỗi hệ thống xác thực nếu sự cố vẫn tiếp diễn.", null },
                    { new Guid("10e3219d-d8aa-45ea-88d0-c8f728bf0d00"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6468), "API kết nối với hệ thống thanh toán báo lỗi 500 Internal Server Error.", 2, "1. Xác minh API key và endpoint có chính xác không. \n2. Kiểm tra log server để biết nguyên nhân lỗi. \n3. Liên hệ với nhà cung cấp API để kiểm tra nếu cần.", null },
                    { new Guid("2c1c80f8-56df-4b2b-bb47-362ee218f494"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6464), "Trang dashboard tải rất chậm, mất hơn 10 giây để hiển thị dữ liệu.", 1, "1. Kiểm tra truy vấn SQL xem có truy vấn nặng không. \n2. Sử dụng caching để giảm tải dữ liệu truy vấn lặp lại. \n3. Tối ưu code frontend/backend để giảm thời gian tải trang.", null },
                    { new Guid("4b1eca13-b127-4564-a70d-60ccbabe15fc"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6476), "Thanh toán không thành công do lỗi ngân hàng.", 6, "1. Kiểm tra xem số dư tài khoản của khách hàng có đủ không. \n2. Hướng dẫn thử lại hoặc sử dụng phương thức thanh toán khác. \n3. Kiểm tra log giao dịch để xác minh nguyên nhân.", null },
                    { new Guid("4f06d26b-eb45-4049-bb61-9b13bf31bb0f"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6478), "Người dùng yêu cầu hoàn tiền do giao dịch lỗi.", 7, "1. Xác minh giao dịch và lý do hoàn tiền. \n2. Thực hiện hoàn tiền theo chính sách công ty. \n3. Gửi thông báo cho người dùng về trạng thái hoàn tiền.", null },
                    { new Guid("6dbca09a-7017-410b-af7c-b0e3c242698c"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6487), "Vấn đề khác không thuộc các danh mục trên.", 11, "1. Xác minh chi tiết vấn đề. \n2. Chuyển đến bộ phận phù hợp để xử lý. \n3. Phản hồi cho người dùng về cách giải quyết.", null },
                    { new Guid("86d0d783-7455-4808-b09d-f1bdee176b0d"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6484), "Người dùng yêu cầu cập nhật thông tin cá nhân (email, số điện thoại).", 10, "1. Xác minh danh tính người yêu cầu. \n2. Cập nhật thông tin theo yêu cầu nếu hợp lệ. \n3. Gửi xác nhận thay đổi cho người dùng.", null },
                    { new Guid("9fe1b731-e508-486f-96a9-d93536bc365e"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6480), "Người dùng bị trừ sai số tiền khi thanh toán.", 8, "1. Kiểm tra lịch sử giao dịch và xác minh số tiền bị trừ. \n2. Nếu lỗi thuộc về hệ thống, tiến hành hoàn tiền cho khách hàng. \n3. Sửa lỗi hệ thống nếu có để tránh tái diễn.", null },
                    { new Guid("bda4fac3-7ac0-4654-87ca-21b737ca685d"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6472), "Tài khoản bị khóa do nhập sai mật khẩu nhiều lần.", 4, "1. Kiểm tra trạng thái tài khoản trong hệ thống. \n2. Nếu bị khóa, hướng dẫn người dùng xác thực email hoặc liên hệ hỗ trợ. \n3. Cung cấp tùy chọn mở khóa tài khoản nếu hợp lệ.", null },
                    { new Guid("d0dbfd97-04ee-43f7-b0ee-99483d06a731"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6482), "Cần thêm tính năng xuất báo cáo sang Excel.", 9, "1. Ghi nhận yêu cầu và đưa vào backlog. \n2. Xác định mức độ ưu tiên của tính năng. \n3. Đưa vào kế hoạch phát triển nếu phù hợp.", null },
                    { new Guid("e27e4ca9-a954-4c9c-a1b3-c1803d1bf899"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6474), "Người dùng không thể truy cập trang quản lý mặc dù có quyền admin.", 5, "1. Kiểm tra xem quyền truy cập đã được cấp đúng chưa. \n2. Cập nhật phân quyền nếu cần thiết. \n3. Kiểm tra lại mã nguồn hoặc chính sách bảo mật.", null },
                    { new Guid("ffbf2759-037f-4f67-bd99-040b2db3222e"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6461), "Lỗi không thể thêm sản phẩm vào giỏ hàng.", 0, "1. Kiểm tra lại logic xử lý thêm sản phẩm vào giỏ hàng. \n2. Xem xét console log hoặc error log để xác định lỗi cụ thể. \n3. Cập nhật hoặc sửa lỗi trong mã nguồn nếu cần thiết.", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("17b8cac1-6f3b-4915-bdff-9c79a7038d15"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6388), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("b3f8be2e-b550-472e-ba86-035476b4296d"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6385), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("d549690a-59da-4c91-8179-7ba2102800e2"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6361), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("114f2c5f-1bd9-40db-b843-439bc8977870"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6408), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6409), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("43ad2d80-0753-48c1-b699-8a0267205d33"), "anhNv@gmail.com", "Nguyễn Văn Anh", true, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6390), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6393), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("80776a2c-237f-4f1a-b014-a8c40698f02e"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6415), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6416), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("b90b8b8f-0a33-419c-9e44-a69531155625"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6411), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6413), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("c55339f0-3fc2-4de6-8ca5-c78a49248981"), "BinhLeV@gmail.com", "Lê Văn Bình", true, 3, new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6403), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 2, 21, 1, 32, 47, 613, DateTimeKind.Local).AddTicks(6405), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null }
                });
