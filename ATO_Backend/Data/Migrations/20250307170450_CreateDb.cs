        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certification_Product_ProductId1",
                        column: x => x.ProductId1,
                        principalTable: "Product",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_Certification_TouristFacility_ProductId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("053d18ef-ba0e-4141-b142-898d28fa9b5d"), 0, null, "dcb6ff39-3284-4f39-8d5b-b7ae45b5982b", null, "truongthu112201@gmail.com", true, "Tourism Companies", null, false, null, "TRUONGTHU112201@GMAIL.COM", "TOURISMCOMPANIES", "AQAAAAIAAYagAAAAEN2YY+cKlqGwUllJj5y9k84OPiU9u+5PEgW3Dv6nZmd9B8fcvJLrDJshGPCXyvEZpQ==", null, false, "600228bd-692e-4908-a01a-347e609acf89", false, "TourismCompanies", true },
                    { new Guid("11a068d3-9af4-484c-82a2-e2b5c9d8b5ab"), 0, null, "d6cc8e99-847c-4ac2-b245-01bb99bfa41d", null, "lucianafuste0717@gmail.com", true, "Content Moderators", null, false, null, "LUCIANAFUSTE0717@GMAIL.COM", "CONTENTMODERATORS", "AQAAAAIAAYagAAAAEC/1L0kdf/qSnafAhCbHs7vo4kJi1vN21p4FEXHJ8QEEjWDT8pzDMEG9kJav4S0aPQ==", null, false, "551344ba-36cd-4a18-9f75-e57a8a99e85e", false, "ContentModerators", true },
                    { new Guid("64454a5e-9883-4548-9a9d-d7986bf6b3ad"), 0, null, "906cab16-18ce-48fd-b16d-a0e846c21107", null, "thuthuhe2501@gmail.com", true, "TourGuides", null, false, null, "THUTHUHE2501@GMAIL.COM", "TOURGUIDES", "AQAAAAIAAYagAAAAENs8l1jzaDRBe+USrDMaLSH+U2p5x9b/Egmkh7m1KxSUhzTLQT11CWGEfFjFBJNwZQ==", null, false, "66a21601-68ab-4866-90ef-2e8cba9c0b91", false, "TourGuides", true },
                    { new Guid("a631bb94-66d8-44db-932b-532892d87754"), 0, null, "6c33dc40-80e8-48dc-991c-5d3eaf0c91a1", null, "thutt170727@gmail.com", true, "Agricultural Tourism Facility Owners", null, false, null, "THUTT170727@GMAIL.COM", "ATFO", "AQAAAAIAAYagAAAAEMJfo4xv7yv/CdzXwWLlbYSi/aTNvlk5Gg1IolDeF8A7StAQznozCvLaRBBh7jARLQ==", null, false, "372d9a6d-a039-4d5f-a7ae-e4673bb0bff3", false, "ATFO", true },
                    { new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), 0, null, "6e582c70-3077-4e69-a946-209b14531c4f", null, "thutt170727@gmail.com", true, "Administrator", null, false, null, "THUTT170727@GMAIL.COM", "ADMINISTRATOR", "AQAAAAIAAYagAAAAEKScs+N/vI9ZM/V1eZpiNB9sL/VSHy+tG6xiFUWTy/Mt7l1lUxlWHusv3tukLBTSUw==", null, false, "f77bbc89-7844-413e-b488-13427cd164fe", false, "Administrator", true },
                    { new Guid("e025738e-4686-4282-abc3-dae9c65907f0"), 0, null, "5f9db88a-0aff-4207-b0ab-f50bc0d7d1ca", null, "ThangNVSE151059@fpt.edu.vn", true, "Tourists", null, false, null, "THANGNVSE151059@FPT.EDU.VN", "TOURIST", "AQAAAAIAAYagAAAAEEzgc2R5hD9mQKQtrx68TNx1fEmz3lrtpejh211LTzEs91n7zrLBAw7xKXZffY8ExQ==", null, false, "8cc6097f-42ba-4257-96e9-3b285989f5f2", false, "Tourists", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "SmtpServer", 0, "smtp.gmail.com", new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(3876), null },
                    { 2, "Port", 0, "587", new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(3878), null },
                    { 3, "Email", 0, "thangnvse151059@fpt.edu.vn", new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(3879), null },
                    { 4, "AppPassword", 0, "sllgcjfbkpgcwnmp", new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(3880), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("204142f9-0f1b-4911-9a62-084d79de6c77"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3795), "Người dùng yêu cầu hoàn tiền do giao dịch lỗi.", 7, "1. Xác minh giao dịch và lý do hoàn tiền. \n2. Thực hiện hoàn tiền theo chính sách công ty. \n3. Gửi thông báo cho người dùng về trạng thái hoàn tiền.", null },
                    { new Guid("2c73e54d-1e2c-4226-aa6a-33b21a0940fe"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3791), "Người dùng không thể truy cập trang quản lý mặc dù có quyền admin.", 5, "1. Kiểm tra xem quyền truy cập đã được cấp đúng chưa. \n2. Cập nhật phân quyền nếu cần thiết. \n3. Kiểm tra lại mã nguồn hoặc chính sách bảo mật.", null },
                    { new Guid("34a810db-e2dc-487f-9419-b953408e8175"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3770), "Người dùng không thể đăng nhập dù đã nhập đúng tài khoản và mật khẩu.", 3, "1. Kiểm tra xem tài khoản có bị khóa hay không. \n2. Hướng dẫn người dùng đặt lại mật khẩu. \n3. Kiểm tra lỗi hệ thống xác thực nếu sự cố vẫn tiếp diễn.", null },
                    { new Guid("373dfd12-c85c-4936-aba4-810cf666a883"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3789), "Tài khoản bị khóa do nhập sai mật khẩu nhiều lần.", 4, "1. Kiểm tra trạng thái tài khoản trong hệ thống. \n2. Nếu bị khóa, hướng dẫn người dùng xác thực email hoặc liên hệ hỗ trợ. \n3. Cung cấp tùy chọn mở khóa tài khoản nếu hợp lệ.", null },
                    { new Guid("38403780-65aa-4160-af33-d42c38af1099"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3818), "Vấn đề khác không thuộc các danh mục trên.", 11, "1. Xác minh chi tiết vấn đề. \n2. Chuyển đến bộ phận phù hợp để xử lý. \n3. Phản hồi cho người dùng về cách giải quyết.", null },
                    { new Guid("51e98c2b-ba10-4629-92e1-6fad66934992"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3773), "Lỗi không thể thêm sản phẩm vào giỏ hàng.", 0, "1. Kiểm tra lại logic xử lý thêm sản phẩm vào giỏ hàng. \n2. Xem xét console log hoặc error log để xác định lỗi cụ thể. \n3. Cập nhật hoặc sửa lỗi trong mã nguồn nếu cần thiết.", null },
                    { new Guid("9d29fc55-ce7e-499e-956d-bf3fb22d80b8"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3812), "Cần thêm tính năng xuất báo cáo sang Excel.", 9, "1. Ghi nhận yêu cầu và đưa vào backlog. \n2. Xác định mức độ ưu tiên của tính năng. \n3. Đưa vào kế hoạch phát triển nếu phù hợp.", null },
                    { new Guid("a570b5af-3e11-41b0-aff2-8b49570bda22"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3775), "Trang dashboard tải rất chậm, mất hơn 10 giây để hiển thị dữ liệu.", 1, "1. Kiểm tra truy vấn SQL xem có truy vấn nặng không. \n2. Sử dụng caching để giảm tải dữ liệu truy vấn lặp lại. \n3. Tối ưu code frontend/backend để giảm thời gian tải trang.", null },
                    { new Guid("c08f3901-7408-40b6-b805-7e6181ec0108"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3814), "Người dùng yêu cầu cập nhật thông tin cá nhân (email, số điện thoại).", 10, "1. Xác minh danh tính người yêu cầu. \n2. Cập nhật thông tin theo yêu cầu nếu hợp lệ. \n3. Gửi xác nhận thay đổi cho người dùng.", null },
                    { new Guid("c5e4c15d-e8ab-4840-981f-461e2d99b023"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3779), "API kết nối với hệ thống thanh toán báo lỗi 500 Internal Server Error.", 2, "1. Xác minh API key và endpoint có chính xác không. \n2. Kiểm tra log server để biết nguyên nhân lỗi. \n3. Liên hệ với nhà cung cấp API để kiểm tra nếu cần.", null },
                    { new Guid("ccec88f5-2253-4103-9cd4-497f47539476"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3793), "Thanh toán không thành công do lỗi ngân hàng.", 6, "1. Kiểm tra xem số dư tài khoản của khách hàng có đủ không. \n2. Hướng dẫn thử lại hoặc sử dụng phương thức thanh toán khác. \n3. Kiểm tra log giao dịch để xác minh nguyên nhân.", null },
                    { new Guid("de4f196a-0235-468d-8038-45a92766874b"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3810), "Người dùng bị trừ sai số tiền khi thanh toán.", 8, "1. Kiểm tra lịch sử giao dịch và xác minh số tiền bị trừ. \n2. Nếu lỗi thuộc về hệ thống, tiến hành hoàn tiền cho khách hàng. \n3. Sửa lỗi hệ thống nếu có để tránh tái diễn.", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("17b8cac1-6f3b-4915-bdff-9c79a7038d15"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3638), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("b3f8be2e-b550-472e-ba86-035476b4296d"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3636), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("d549690a-59da-4c91-8179-7ba2102800e2"), "thangnvse151000@fpt.edu.vn", "Nguyễn Việt Thắng", false, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3616), null, null, null, "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("114f2c5f-1bd9-40db-b843-439bc8977870"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3654), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3655), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("43ad2d80-0753-48c1-b699-8a0267205d33"), "anhNv@gmail.com", "Nguyễn Văn Anh", true, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3641), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3643), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("80776a2c-237f-4f1a-b014-a8c40698f02e"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3662), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3663), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("b90b8b8f-0a33-419c-9e44-a69531155625"), "AnhNLV1203@gmail.com", "Nguyễn Thị Lan Anh", true, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3658), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3660), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null },
                    { new Guid("c55339f0-3fc2-4de6-8ca5-c78a49248981"), "BinhLeV@gmail.com", "Lê Văn Bình", true, 3, new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3650), new Guid("b8c777a9-55b9-4b3d-860a-d7b56e4c24b7"), new DateTime(2025, 3, 8, 0, 4, 50, 573, DateTimeKind.Local).AddTicks(3651), "Bạn thực hiện đăng nhập lại vào hệ thống tài khoản đã được kích hoạt lại.", "Tài khoản của em đăng nhập vào hệ thống không được do tài khoản đã bị khóa! Anh chị hỗ trợ e mở lại tài khoản ạ!", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00e87e83-6a55-4ce8-81ff-30df002d6622"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4381), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("4335f0e8-9ea3-48a7-b0cf-5185ff675dde"), 100000.0, 1000.0, null },
                    { new Guid("042d9e12-9bcb-44a0-ac08-6bf21ab5716c"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4639), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("65966980-988a-4d92-89b4-2b74425fe3f3"), 100000.0, 1000.0, null },
                    { new Guid("0878711f-bd13-4101-8abc-fe4c98268dac"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4466), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("69006cfe-5233-4b8e-b181-d81a485873e3"), 100000.0, 1000.0, null },
                    { new Guid("19ed2662-5801-4e07-bcbb-17da273e9f82"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4343), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c58bb9c8-ad26-40bc-a5d5-f8d09049f7aa"), 100000.0, 1000.0, null },
                    { new Guid("24708be9-4cf6-405b-acea-e4222042a777"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4350), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("4335f0e8-9ea3-48a7-b0cf-5185ff675dde"), 100000.0, 1000.0, null },
                    { new Guid("3e3febd4-42fb-416e-ba58-fc237aee8c4f"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4427), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("798a3b9b-f7c9-4e84-a563-39421e6585f4"), 100000.0, 1000.0, null },
                    { new Guid("467a3135-29be-476b-9e60-8e41a08eb9d7"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4604), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("98e14da8-40dd-4e50-bd9b-eb74112f6625"), 100000.0, 1000.0, null },
                    { new Guid("53463b60-c514-4c02-98f7-a89bcab1049f"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4474), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("69006cfe-5233-4b8e-b181-d81a485873e3"), 100000.0, 1000.0, null },
                    { new Guid("5a436dbe-08c2-4504-a222-d044596f05cd"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4648), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("65966980-988a-4d92-89b4-2b74425fe3f3"), 100000.0, 1000.0, null },
                    { new Guid("611c3c3e-e995-446d-a6c9-f1ded0610f89"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4632), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("65966980-988a-4d92-89b4-2b74425fe3f3"), 100000.0, 1000.0, null },
                    { new Guid("646b4c64-2051-4719-b6e7-7ca421574c34"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4335), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c58bb9c8-ad26-40bc-a5d5-f8d09049f7aa"), 100000.0, 1000.0, null },
                    { new Guid("75e134c1-93ea-4d31-8ed7-fcba2cc7ad98"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4624), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("639e1cfc-1266-4b30-9022-3927c1721afd"), 100000.0, 1000.0, null },
                    { new Guid("7c8167f8-1dcb-4f3d-a0df-9e40e166868f"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4589), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("98e14da8-40dd-4e50-bd9b-eb74112f6625"), 100000.0, 1000.0, null },
                    { new Guid("83ce704f-ceb8-4b7f-a9b0-e4297c834e0b"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4373), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("4335f0e8-9ea3-48a7-b0cf-5185ff675dde"), 100000.0, 1000.0, null },
                    { new Guid("8ae5da3a-4a4f-40c5-8a16-183909ef3a42"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4419), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("798a3b9b-f7c9-4e84-a563-39421e6585f4"), 100000.0, 1000.0, null },
                    { new Guid("90bb8fa7-9766-4228-b103-2433965d89be"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4434), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("f51aaaf7-9bb1-4a69-a634-0ab1162fd9c1"), 100000.0, 1000.0, null },
                    { new Guid("a992b841-55ad-4b38-837f-60dd9d17313c"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4454), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("f51aaaf7-9bb1-4a69-a634-0ab1162fd9c1"), 100000.0, 1000.0, null },
                    { new Guid("b0f7a89b-517d-4adf-89e9-1b5477d2eb87"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4325), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c58bb9c8-ad26-40bc-a5d5-f8d09049f7aa"), 100000.0, 1000.0, null },
                    { new Guid("b27e4e5a-83a8-457e-a191-a5bb16821ef4"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4446), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("f51aaaf7-9bb1-4a69-a634-0ab1162fd9c1"), 100000.0, 1000.0, null },
                    { new Guid("bacb08e2-f5a9-4ab4-a71e-92fb1f2f8671"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4388), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("798a3b9b-f7c9-4e84-a563-39421e6585f4"), 100000.0, 1000.0, null },
                    { new Guid("c08f68d2-1af2-4e0e-b589-bf874355bbd5"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4597), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("98e14da8-40dd-4e50-bd9b-eb74112f6625"), 100000.0, 1000.0, null },
                    { new Guid("c883f066-84f2-4e55-bd27-d8432598f2e9"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4578), new DateTime(2027, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("69006cfe-5233-4b8e-b181-d81a485873e3"), 100000.0, 1000.0, null },
                    { new Guid("d178794f-3a28-417a-909c-4d68b621d21c"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4618), new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("639e1cfc-1266-4b30-9022-3927c1721afd"), 100000.0, 1000.0, null },
                    { new Guid("f17fa8f8-24ca-4c50-a899-f0e797a30cff"), new DateTime(2025, 3, 7, 17, 4, 50, 573, DateTimeKind.Utc).AddTicks(4611), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("639e1cfc-1266-4b30-9022-3927c1721afd"), 100000.0, 1000.0, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certification_ProductId1",
                table: "Certification",
                column: "ProductId1");
